...
const ProductCard = ({product}) => {
    const {rating, name, price, brand, category, img, id} = product;
  return (
    <div className=''>
      <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mx-auto">
        <img
        ...
        <div className="px-6 py-4">
          ...
          <div className="flex items-center mt-4 text-gray-700 ">
            <FaIndustry/>
            <h1 className="px-2 text-sm">Brand: {brand}</h1>
          </div>
          <div className="flex items-center mt-4 text-gray-700 ">
          <BiCategory/>
